...
<body>
    ...
    <div id="caja1">
        <nav class=" bg-zinc-800 flex flex-row w-screen h-screen relative">
            ...
            <img src="{{ asset('img/logotipo1.svg') }}" class="xl:w-[45%] lg:w-4/12 md:w-[50%] absolute lg:top-1/4 md:top-[28%] left-7">
            ...
            <img class=" float-left lg:w-8/12 md:w-[60%] h-screen lg:ml-0 md:ml-[29%]" src="{{ asset('img/img1.png') }}">
            
            <a href="{{ route('login') }}" class="text-orange-600 text-center leading-none lg:text-3xl md:text-2xl absolute top-2/3  left-48 hover:transition-all duration-500 ease-in-out hover:text-zinc-800 hover:bg-orange-600 pointer rounded-full px-10 py-14 mb-5 "><span class="block">Inicia</span> <b>AHORA</b></a>
        </nav>
        ...
        <div class="w-screen h-96 bg-orange-600 flex flex-column">
            ...
            <ul class="list-disc lg:text-3xl md:text-2xl float-left text-zinc-800 font-normal pl-20 pt-10">
                ...
                <li class="pt-2"><p>¿Falta de eficiencia en el ambiente laboral? </p></li>
                <li class="pt-2"><img src="/img/logotipo2.svg" class="lg:w-5/6 md:w-[95%] pt-10"></li>
            </ul>

            <img src="{{ asset('img/img2.png') }}" class="lg:h-full md:h-[90%] md:w-[38%] cover float-right lg:mr-10 md:mr-5">            
        </div>
        
        <!--tercera vision-->
        <div class="bg-zinc-800 w-screen h-screen relative flex">
            <div class="border border-green-500">
                <p class="lg:text-2xl md:text-xl text-orange-600 text-left leading-none font-bold italic top-12 left-7 ">
                    Nuestra aplicación está diseñada para asegurar tu comodidad y acceso en todo momento
                </p>

                <p class="lg:text-2xl md:text-lg text-white text-left leading-none font-light top-28 left-7 ">
                    ...
                    <span>Además, lleva contigo tu propio registro y almacenamiento de reportes, fotos, videos, audios e incluso documentos. Todo en un solo lugar, para que tengas toda la información que necesitas al alcance de tu mano.</span><br><br>

                    <span>No importa si eres un profesional independiente, un estudiante o un emprendedor, nuestra plataforma te ayudará a organizar tus tareas, proyectos y documentos de una manera eficiente y práctica</span>
                </p>

                <a href="{{ route('login') }}" class="text-orange-600 text-center leading-none lg:text-3xl md:text-2xl absolute top-2/3  left-48 hover:transition-all duration-500 ease-in-out hover:text-zinc-800 hover:bg-orange-600 pointer rounded-full px-10 py-14 mb-5 "><span class="block">Inicia</span> <b>AHORA</b></a>
            </div>
            <img class="border border-red-500 w-7/12 h-screen" src="{{ asset('img/img3.png') }}">
        ...
        <div class="w-screen lg:h-60 md:h-40 xl:h-[50%] bg-zinc-800 lg:text-3xl md:text-xl text-center font-bold italic ">
            ...
            <img src="{{ asset('img/logotipo3.svg') }}" class="w-4/12  m-auto lg:pt-20 md:pt-10 xl:pt-20 xl:pb-20" >
