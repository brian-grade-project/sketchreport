...
<header class="navbar bg-zinc-800 fixed top-0 left-0 right-0 z-50">
    <div class="w-[150px]">
    ...
    <div class="px-4 flex items-center justify-end ml-auto">
        <form id="search-form" method="GET" class="flex items-center">
            ...
            <button type="submit" class="btn btn-xs bg-orange-600 hover:bg-orange-700 text-zinc-900 border-none rounded-full w-8 h-8 p-0 mr-8">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                </svg>
            </button>
        </form>
        <a href="{{ route('profile') }}" class="w-[30px] h-[30px] rounded-full border-2 border-orange-600 fill-orange-600 hover:bg-orange-600 hover:fill-zinc-800 transition-all duration-300">
