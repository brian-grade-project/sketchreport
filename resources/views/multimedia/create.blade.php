...
<div class="w-[100vw] h-[100vh] bg-[url(/img/imglogin.jpg)] bg-no-repeat bg-cover pt-5" >
    ...
    <div class="w-[80%] h-[80%] xl:h-[80%] lg:h-[75%] bg-zinc-800 m-auto mt-5 relative overflow-hidden rounded-3xl  ">
        ...
        <div class="absolute left-[2%] top-[2%] w-[15%] h-[10%]">
           <svg class="w-[40%] fill-orange-600 hover:bg-orange-600 hover:fill-zinc-800 transition-all duration-500 ease-in-out rounded-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g id="arrow-left"><path d="M11,18.75a.74.74,0,0,1-.53-.22l-6-6a.75.75,0,0,1,0-1.06l6-6a.75.75,0,0,1,1.06,1.06L6.06,12l5.47,5.47a.75.75,0,0,1,0,1.06A.74.74,0,0,1,11,18.75Z"/><path d="M19,12.75H5a.75.75,0,0,1,0-1.5H19a.75.75,0,0,1,0,1.5Z"/></g></svg>
            ...
            <div class=" relative ml-16 lg:w-60 md:w-[48%] ">
                ...
                <input type="text" class="bg-white rounded-full w-full p-1 px-2 " name="titulo" id="titulo" placeholder="Ingrese titulo">
            ...
            <div class="relative   ml-14 w-[25%]">
                ...
                <input type="date" class="bg-white rounded-full w-full p-1 px-2 " name="titulo" id="titulo" placeholder="Ingrese fecha">

            </div>

            <div class="relative float-left ml-16 w-[40%] h-[10%]">

              <label for="importar" class="text-xl text-orange-600 block mt-8 pb-1 font-light">Archivos multimedia</label>
              <input type="file" multiple class=" resize-none bg-white rounded w-full h-full rounded-full mb-5" name="importar" id="importar" placeholder="">

            </div>

            <div class="relative float-left flex flex-col justify-center ml-16 w-[86%] border-4 border-dashed border-orange-600 hover:bg-zinc-300/40 "> 

              <p class="text-xl text-orange-600 block pb-1 pt-2 font-light m-auto font-medium block">Arrastra para subir</p>
              <p class="text-xl text-orange-600 block font-light m-auto block text-center">Suelta en esta área tu contenido para que se pueda subir</p>
              <img src="/img/cloud-upload.svg" alt="Cloud-upload" class="flex m-auto w-[15%] lg:w-[25%] xl:w-[15%] md:w-[25%]  ">
