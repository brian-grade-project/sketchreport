...
<div class="w-[100vw] h-[100vh] bg-[url(/img/imglogin.jpg)] bg-no-repeat bg-cover pt-5 relative" >
  ...
  <script>
    ...
    const reports = [
      { id: 1, name: "Reporte mensual", date: "2023-10-01", type: "PDF", thumbnail: "https://via.placeholder.com/50" },
      { id: 2, name: "Foto evento", date: "2023-09-15", type: "Imagen", thumbnail: "https://via.placeholder.com/50" }
    ];
