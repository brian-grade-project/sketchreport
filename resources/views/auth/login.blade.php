    ...
    <div class="w-screen h-screen">
        ...
        <div class="h-screen w-2/6 bg-zinc-800 float-right relative">
            ...
            <form>
                ...
                <input class="bg-white text-orange-600  rounded-full w-7/12 m-auto ml-24  p-1 focus:bg-orange-600 text-yellow-800" type="text" placeholder="Ingrese usuario" id="usuario">

                <label class="text-xl text-orange-600 block ml-28 mt-5 font-light" for="contraseña">Contraseña</label>
                <input class="bg-white text-orange-600  rounded-full w-7/12 m-auto ml-24 p-1 focus:bg-orange-600 text-zinc-800" type="password" placeholder="Ingrese contraseña" id="contraseña">
            </form>
